...
#ifndef MVVMC_SD_DEMO_SWIFT_H
#define MVVMC_SD_DEMO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="MVVMC_SD_Demo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC13MVVMC_SD_Demo11AppDelegate")
...
@class NSCoder;
SWIFT_CLASS("_TtC13MVVMC_SD_Demo10FooterView")
...
@class NSString;
SWIFT_CLASS("_TtC13MVVMC_SD_Demo11HoldingCell")
@interface HoldingCell : UITableViewCell
...
@class NSBundle;
SWIFT_CLASS("_TtC13MVVMC_SD_Demo22HoldingsViewController")
@interface HoldingsViewController : UIViewController
...
@class UITableView;
@class NSIndexPath;
@interface HoldingsViewController (SWIFT_EXTENSION(MVVMC_SD_Demo)) <UITableViewDataSource>
...
@class UIWindow;
@class UIScene;
SWIFT_CLASS("_TtC13MVVMC_SD_Demo13SceneDelegate")
...
SWIFT_CLASS("_TtC13MVVMC_SD_Demo14SummaryRowView")
@interface SummaryRowView : UIView
- (nonnull instancetype)initWithFrame:(CGRect)frame OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end

SWIFT_CLASS("_TtC13MVVMC_SD_Demo11SummaryView")
